...
namespace WindowsFormsApp2
{
    ...
    public partial class Form_Degrau : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            byte[] data = { Convert.ToByte(0), 8, Convert.ToByte(valor1), Convert.ToByte(valor2), Convert.ToByte(0), Convert.ToByte(1) };
            (f1 as Form1).SendData(data);
        ...
        {
            // byte inicio,tarefa,dado1,dado2,dado3, byte fim
            (f1 as Form1).SendData(0xAA, 1, 10, 20, 30, 0xBB);
